...
const routes = [
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_locations_locations_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./locations/locations.module */ 4985)).then(m => m.LocationsPageModule)
    },
    {
        path: 'authentication',
    ...
    {
        path: 'search',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_locations_search_search_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./locations/search/search.module */ 3331)).then(m => m.SearchPageModule),
        canLoad: [_authentication_authentication_guard__WEBPACK_IMPORTED_MODULE_0__.AuthenticationGuard]
    },
    {
        path: 'event-offers',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("common"), __webpack_require__.e("src_app_locations_event-offers_event-offers_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./locations/event-offers/event-offers.module */ 7787)).then(m => m.EventOffersPageModule),
        canLoad: [_authentication_authentication_guard__WEBPACK_IMPORTED_MODULE_0__.AuthenticationGuard]
    },
    {
        path: 'attend',
...
/* harmony import */ var _Users_annettemichel_Desktop_Webanwendung_Hausarbeit_Ryborsch_Michel_EventHour_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./app.component.html */ 5158);
...
/* harmony import */ var _capacitor_splash_screen__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @capacitor/splash-screen */ 7567);
/* harmony import */ var _authentication_authentication_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./authentication/authentication.service */ 5004);
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            if (_capacitor_core__WEBPACK_IMPORTED_MODULE_1__.Capacitor.isPluginAvailable('SplashScreen')) {
...
AppComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_6__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_7__.Component)({
        selector: 'app-root',
        template: _Users_annettemichel_Desktop_Webanwendung_Hausarbeit_Ryborsch_Michel_EventHour_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
    })
], AppComponent);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.NgModule)({
        ...
        entryComponents: [],
        imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__.BrowserModule, _angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClientModule, _ionic_angular__WEBPACK_IMPORTED_MODULE_6__.IonicModule.forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_0__.AppRoutingModule],
        providers: [
...
AuthenticationGuard = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
...
let AuthenticationService = class AuthenticationService {
    constructor() {
        this._isAuthenticated = true; //TODO auf false setzen!!!
        this._userId = 'user1';
    }
    get isAuthenticated() {
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ("<ion-app>\n  <ion-menu side=\"start\" contentId=\"menuContend\">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title> EventHour </ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content class=\"ion-padding\">\n      <ion-item>\n        <ion-label>Dark-Theme</ion-label>\n        <ion-toggle slot=\"end\" (ionChange)=\"toggleTheme($event)\"></ion-toggle>\n      </ion-item>\n      <p></p>\n    </ion-content>\n  </ion-menu>\n  <ion-router-outlet id=\"menuContend\"></ion-router-outlet>\n</ion-app>\n");
